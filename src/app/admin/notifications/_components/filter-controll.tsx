...
export const FilterControll = () => {
  ...
  const handleSearch = useDebouncedCallback(
    (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      router.push(`/admin/notifications?${newParams.toString()}`, {
        scroll: false,
      });
    },
    500
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <select
              ...
              className="w-full appearance-none border-2 border-neutral-700 p-2 pr-10 focus:outline-none focus:ring-2 focus:ring-red-500"
            >
              <option value="ALL">Semua Tipe</option>
              <option value="NEW_PAYMENT">Pembayaran Baru</option>
              <option value="NEW_COMPLAINT">Keluhan Baru</option>
              <option value="INSTALLATION_REQUEST">Permintaan Instalasi</option>
              <option value="USER_ACTIVATION_REQUEST">
                Permintaan Aktivasi
              </option>
            </select>
