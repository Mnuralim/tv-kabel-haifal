...
import { InstallationInformation } from "./installation-information";
...
export const InstallationRequestDetail = ({ request }: Props) => {
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-black border-b-8 border-blue-500 pb-2 text-black">
            Detail Permintaan Instalasi
          </h1>
        </div>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <InstallationInformation request={request} />
          <CustomerInformation customer={request.customer} />
        </div>
